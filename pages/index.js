...
export default function Home() {
  ...
  console.log(addExpenseModalBudgetId);
    ...
    <>
      <div className="">
        ...
        <main className="sticky top-0 z-50 flex justify-between bg-blue-600 p-5 items-center">
          <h1 className="text-xl text-white">BUDGETS</h1>
          <div className="">
            <button
              onClick={() => {
                setShowModal(true);
            ...
            <button
              ...
              className="text-white rounded border border-green-600 hover:bg-green-600 px-2 py-1"
            >
              add expense
            </button>
          </div>
